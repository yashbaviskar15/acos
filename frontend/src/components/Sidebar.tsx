...
export const Sidebar: React.FC<SidebarProps> = ({ 
  ...
  const sections: NavSection[] = [
    ...
    },
    {
      ...
      items: [
        { id: 'catalog', label: 'Service Catalog', icon: LayoutGrid, badge: 'All Services', sublabel: 'Explore & Provision' },
      ]
    },
    {
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-xs animate-fadeIn font-sans">
          <div className="w-full max-w-md bg-white dark:bg-[#111827] border border-slate-200 dark:border-slate-800 rounded-2xl p-6 shadow-2xl space-y-4">
            ...
            <p className="text-xs text-slate-600 dark:text-slate-300 leading-relaxed">
              Are you sure you want to sign out from <strong>{user?.email || displayName || 'your account'}</strong>? Any unsaved terminal workflows or uncommitted configurations will be closed.
            </p>
