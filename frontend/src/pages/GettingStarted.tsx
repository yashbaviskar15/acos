...
const serviceGuides = [
  {
    ...
    apiExample: `curl -X POST http://localhost:8000/api/v1/compute/instances \\
  ...
  },
  {
    ...
    apiExample: `curl -X POST http://localhost:8000/api/v1/kubernetes/clusters \\
  -H "Content-Type: application/json" \\
  ...
  },
  {
    ...
    apiExample: `curl -X POST http://localhost:8000/api/v1/storage/buckets \\
  -H "Content-Type: application/json" \\
  ...
  },
  {
    ...
    apiExample: `curl -X POST http://localhost:8000/api/v1/databases \\
  -H "Content-Type: application/json" \\
  ...
  },
  {
    ...
    apiExample: `curl -X POST http://localhost:8000/api/v1/cicd/pipelines \\
  -H "Content-Type: application/json" \\
...
curl http://localhost:8000/api/v1/monitoring/audit-log`,
  },
];
