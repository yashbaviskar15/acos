...
const serviceGuides = [
  {
    ...
    apiExample: `curl -X POST https://arv-backend.vercel.app/api/v1/compute/instances \\
  ...
  },
  {
    ...
    apiExample: `curl -X POST https://arv-backend.vercel.app/api/v1/kubernetes/clusters \\
  -H "Content-Type: application/json" \\
  ...
  },
  {
    ...
    apiExample: `curl -X POST https://arv-backend.vercel.app/api/v1/storage/buckets \\
  -H "Content-Type: application/json" \\
  ...
  },
  {
    ...
    apiExample: `curl -X POST https://arv-backend.vercel.app/api/v1/databases \\
  -H "Content-Type: application/json" \\
  ...
  },
  {
    ...
    apiExample: `curl -X POST https://arv-backend.vercel.app/api/v1/cicd/pipelines \\
  -H "Content-Type: application/json" \\
...
curl https://arv-backend.vercel.app/api/v1/monitoring/metrics

# Get active alerts
curl https://arv-backend.vercel.app/api/v1/monitoring/alerts

# Get microservice health status
curl https://arv-backend.vercel.app/api/v1/monitoring/health`,
  },
  {
    id: 'security',
    icon: ShieldCheck,
...
curl https://arv-backend.vercel.app/api/v1/monitoring/audit-log`,
  },
];
