        ...
        <div className="space-y-3">
          <div className="overflow-x-auto min-w-full">
            <table className="w-full min-w-[850px] text-left text-xs">
              <thead>
                <tr className="border-b border-slate-200 dark:border-slate-800 font-mono font-bold text-slate-500 dark:text-slate-400 bg-slate-50/50 dark:bg-slate-900/50 select-none">
                  <th className="py-3 px-4 cursor-pointer hover:text-slate-200" onClick={() => handleSort('name')}>
                    Resource & Provider {renderSortIcon('name')}
                  </th>
                  <th className="py-3 px-4 cursor-pointer hover:text-slate-200" onClick={() => handleSort('type')}>
                    Type {renderSortIcon('type')}
                  </th>
                  <th className="py-3 px-4 cursor-pointer hover:text-slate-200" onClick={() => handleSort('env')}>
                    Environment {renderSortIcon('env')}
                  </th>
                  <th className="py-3 px-4 cursor-pointer hover:text-slate-200" onClick={() => handleSort('region')}>
                    Region {renderSortIcon('region')}
                  </th>
                  <th className="py-3 px-4 cursor-pointer hover:text-slate-200" onClick={() => handleSort('specs')}>
                    Specs & Capacity {renderSortIcon('specs')}
                  </th>
                  <th className="py-3 px-4 cursor-pointer hover:text-slate-200" onClick={() => handleSort('uptime')}>
                    Uptime {renderSortIcon('uptime')}
                  </th>
                  <th className="py-3 px-4 cursor-pointer hover:text-slate-200" onClick={() => handleSort('status')}>
